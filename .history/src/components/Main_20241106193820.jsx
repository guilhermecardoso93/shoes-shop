...
export function Main() {
  const Product = ({ backgroundColor, title, titleColor, description, buttonText, buttonClass, imageSrc, altText }) => {
    return (
        <div className="product-container">
            <div className="product" style={{ backgroundColor }}>
                ...
                <div className="product-right">
                    ...
                    <div className={`product-button ${buttonClass}`} style={{ marginTop: '10px' }}>
                        {buttonText}
                    </div>
                </div>
            </div>
